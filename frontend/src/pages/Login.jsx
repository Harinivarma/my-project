...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      window.location.reload(); // Refresh to update nav bars
    } catch (err) {
    ...
    <div style={{
      ...
      <div className="glass-card" style={{ width: '100%', maxWidth: '440px', padding: '40px' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', marginTop: '8px', fontSize: '0.9rem' }}>Sign in to continue your learning journey</p>
        </div>
